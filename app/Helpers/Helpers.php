...
/**
 * Class Helpers
 * @package NRViewer\Helpers
 */
class Helpers
{
    /*
     *
     * Создание массива-дерева категорий отсортированного по ключу PARENT_ID
     * используется для создания меню на основе данных из DB
     *
     * */
    /**
     ...
     * @return array
     */
    public static function createTree(array $table): array
    {
        $menu = [];
